...
|---------|----|---------|-------------|-----------|
|Action|String|Yes|DescribeLoadBalancerAttribute|The name of this action. Value:**DescribeLoadBalancerAttribute**
...
|└ForwardPort|Integer|80|The destination listening port. It must be an existing HTTPS listening port.
 ...
 |
|└ListenerForward|String|yes|Indicates whether to enable listener forwarding.
...
|ListenerPortsAndProtocal| | |The same as ListenerPortsAndProtocol.
 ...
 |
|└ListenerPort|Integer|443|The frontend port configured in the SLB instance.
...
-   **NotRenewal**: Stop renewal for the instance. If this value is returned, Alibaba Cloud stops sending notifications about the impending instance expiration, and only sends one reminder on the third day before the instance expires.
