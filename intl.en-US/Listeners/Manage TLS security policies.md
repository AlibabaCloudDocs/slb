...
You can select the TLS security policy when you set advanced configurations of **SSL Certificates** for an HTTPS listener. For more information, see [Add an HTTPS listener](intl.en-US/Listeners/Add an HTTPS listener.md#).

![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21323/156404802311859_en-US.png)
