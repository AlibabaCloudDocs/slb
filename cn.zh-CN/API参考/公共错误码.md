# 公共错误码 {#doc_version_err_Slb_2014-05-15 .reference}
...
|400|VipTooManyListeners|The total number of input listeners exceeds max supported number: 10|实例下监听的总数超限，最多为10个。|
