...
已创建了HTTPS监听，详情参见[添加HTTPS监听](../cn.zh-CN/用户指南/监听/添加HTTPS监听.md#)。
...
6.  开启**监听转发**，选择目的监听为**HTTPS:443**。 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/18827/155800991610550_zh-CN.png)
...
8.  确认后，单击**提交**。 
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/18827/155800991610551_zh-CN.png)
