...
您可以在添加或者配置HTTPS监听，配置**SSL证书**的高级配置时，选择TLS安全策略，详细操作参见[添加HTTPS监听](cn.zh-CN/监听/添加HTTPS监听.md#)。

![配置监听](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/21323/156404802111859_zh-CN.png)
