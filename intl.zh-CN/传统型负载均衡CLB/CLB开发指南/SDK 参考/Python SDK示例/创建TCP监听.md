...
2.  使用编辑器打开slb\_create\_tcp\_listener.py文件，您需要配置用户鉴权参数ACS\_CLIENT，其他参数根据实际情况配置后，保存退出。
    ...
    **说明：** 因为用户鉴权是每个SDK必须执行的操作，所以可以在常量文件中配置AcsClient参数的值，在场景代码中调用常量文件。
    ...
    def create_load_balancer(params):
        ...
        官网API参考链接：https://www.alibabacloud.com/help/zh/doc-detail/27577.htm
        '''
        try:
            # 设置创建SLB实例的调用参数
    ...
    def add_backend_servers(params):
        ...
        官网API参考链接: https://www.alibabacloud.com/help/zh/doc-detail/27632.htm
        '''
        counter = 0
    ...
    def create_tcp_listener(params):
        ...
        官网API参考链接: https://www.alibabacloud.com/help/zh/doc-detail/27594.htm
        '''
        counter = 0
        while counter < TRY_TIME:
            try:
    ...
    def remove_backend_servers(params):
        ...
        官网API参考链接: https://www.alibabacloud.com/help/zh/doc-detail/27633.htm
        '''
        counter = 0
        while counter < TRY_TIME:
            try:
    ...
    def delete_load_balancer(load_balancer_id):
        ...
        官网API参考链接：https://www.alibabacloud.com/help/zh/doc-detail/27579.htm
        '''
        try:
            # 设置删除SLB实例的调用参数
